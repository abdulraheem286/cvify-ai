...
export function SectionHead({
  ...
  if (split) {
    return (
      <div className="grid gap-6 lg:grid-cols-2 lg:items-end lg:gap-20">
        <div>
          {chip}
          <h2 className="mt-4 max-w-xl text-3xl font-bold leading-[1.15] tracking-[-0.01em] sm:text-4xl">{title}</h2>
        </div>
  ...
  return (
    <div className="mx-auto max-w-2xl text-center">
      {chip}
      <h2 className="mt-4 text-3xl font-bold tracking-[-0.01em] sm:text-4xl">{title}</h2>
