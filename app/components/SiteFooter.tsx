      ...
      <div className="mx-auto max-w-[1920px] site-px py-14">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-4 flex gap-2">
              ...
              <Social label="Facebook" href="https://www.facebook.com/profile.php?id=61592170472302" path="M15 4h-2.5A2.5 2.5 0 0 0 10 6.5V10H7.5v3H10v8M10 13h5" />
            </div>
          </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-zinc-200 pt-6 text-sm text-zinc-500 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
            ...
            <Link href="/legal" className="transition-colors hover:text-blue-600">Legal</Link>
          </div>
        </div>
      </div>
    </footer>
