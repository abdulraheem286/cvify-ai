...
export function CvEditor({
  ...
  return (
    <main className="mx-auto w-full max-w-[1920px] flex-1 site-px py-8 print:p-0">
      ...
      {/* Toolbar */}
      <div className="site-mx mb-6 flex items-center justify-between gap-3 border-b border-zinc-200 bg-white site-px py-3 print:hidden">
        <button
          type="button"
          onClick={onBack}
