...
export function ProfileTemplate({ cv, domId = "cv-document", theme = DEFAULT_THEME, datePlacement = "below" }: { cv: CVResult; domId?: string; theme?: Theme; datePlacement?: DatePlacement }) {
  return (
    <div
      id={domId}
          ...
          <Section title="Education">
            {cv.education.map((ed, i) => (
              <div key={i} className="mb-2">
                ...
                <p className="text-sm text-zinc-600">{ed.institution}<InlineDate period={ed.period} placement={datePlacement} className="text-zinc-400" /></p>
