...
export const metadata: Metadata = {
  title: "CV & Resume Templates — CVify AI | Free Professional Templates",
  description:
    "Browse free, professionally designed CV and resume templates — professional, minimal, and creative styles. Switch layouts anytime without losing your content, then recolor and change fonts to make it yours.",
