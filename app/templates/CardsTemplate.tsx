...
export function CardsTemplate({ cv, domId = "cv-document", theme = DEFAULT_THEME, datePlacement = "below" }: { cv: CVResult; domId?: string; theme?: Theme; datePlacement?: DatePlacement }) {
            ...
            {cv.experience.map((job, i) => (
              <div key={i} className="mb-4 last:mb-0">
                <h3 className="font-semibold text-zinc-900">
                  ...
                  {!job.company && <InlineDate period={job.period} type={job.employmentType} placement={datePlacement} className="text-zinc-500" />}
                </h3>
                {job.company && (
