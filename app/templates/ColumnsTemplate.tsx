              ...
              <Section title="Experience">
                {cv.experience.map((job, i) => (
                  <div key={i} className="mb-4 last:mb-0">
                    ...
                    {job.company && <p className="text-xs text-zinc-500">{job.company}<InlineDate period={job.period} type={job.employmentType} placement={datePlacement} className="text-zinc-500" /></p>}
