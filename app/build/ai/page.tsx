...
export const metadata: Metadata = {
  ...
  description:
    "Turn rough notes into a polished, professional CV with the free CVify AI builder. AI writes the wording and formats everything, then download a clean PDF",
